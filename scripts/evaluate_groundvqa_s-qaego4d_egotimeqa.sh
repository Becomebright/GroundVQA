...
do
    python run.py \
        ...
        '+trainer.checkpoint_path="checkpoints/GroundVQA_S-QaEgo4D_EgoTimeQA-COV-test_ROUGE=30.2.ckpt"' \
...
python run.py \
    ...
    dataset.batch_size=64 \
    +trainer.test_only=True \
    '+trainer.checkpoint_path="checkpoints/GroundVQA_S-QaEgo4D_EgoTimeQA-COV-val_R1_03=23.3.ckpt"' \
